...
const LINES = [
  { text: 'Selamat yaww…',                      delay: 800  },
  { text: 'Kakak uda berhasil melewati sempro 🎓', delay: 2200 },
]
...
export default function FakeEndingScene() {
  ...
  useEffect(() => {
    ...
    timers.push(setTimeout(() => next(), 4800))
  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        style={{
          background: 'radial-gradient(ellipse at 50% 50%, transparent 20%, #07070f 80%)',
        }}
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
